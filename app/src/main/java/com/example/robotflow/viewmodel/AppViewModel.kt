...
enum class AppTheme(val primary: Color, val light: Color, val dark: Color) {
    PINK(Color(0xFFFF6699), Color(0xFFFFE6EE), Color(0xFFFF3366)),
    BLUE(Color(0xFF00AEEC), Color(0xFFE5F7FD), Color(0xFF008CBE)),
    GREEN(Color(0xFF2AC864), Color(0xFFEAF9F0), Color(0xFF22A050)),
    HIGH_CONTRAST(Color(0xFF000000), Color(0xFFE0E0E0), Color(0xFF404040))
}
...
enum class PlayMode {
    LOOP_ALL, LOOP_SINGLE, SHUFFLE
}

class AppViewModel(application: Application) : AndroidViewModel(application) {

    var appTheme by mutableStateOf(AppTheme.PINK)
    var uiLanguage by mutableStateOf(UILanguage.JA)
